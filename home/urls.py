...
urlpatterns = [   
                  ...
                  url(r'^question_solving_page(.html)\?papername=(.*)\?question_index=(\d+)', views.question_solving_page),
                  url(r'^question_solving_page(.html)\?papername=(.*)', views.question_solving_page),
